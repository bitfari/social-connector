...
const intCV = (value) => {
    const bigInt = common_1.intToBigInt(value, true);
    if (bigInt > MAX_I128) {
    ...
    return { type: clarityValue_1.ClarityType.Int, value: bigInt };
};
exports.intCV = intCV;
const uintCV = (value) => {
    const bigInt = common_1.intToBigInt(value, false);
    if (bigInt < MIN_U128) {
    ...
    return { type: clarityValue_1.ClarityType.UInt, value: bigInt };
};
