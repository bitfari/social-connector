    ...
    return (h("div", { class: "modal-container" },
      h("div", { class: "modal-body" },
        ...
        browser ? (h("div", { class: "modal-content" },
          h("div", { class: "modal-illustration" },
            h("img", { src: getAssetPath(downloadHiroWalletAssetPath), width: 310 })),
          ...
          h("div", { class: "modal-illustration" },
            h("img", { src: getAssetPath(browserNotSupportedAssetPath), width: 239 })),
