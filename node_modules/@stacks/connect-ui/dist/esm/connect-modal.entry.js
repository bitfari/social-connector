import { r as registerInstance, h, g as getAssetPath, a as getElement } from './index-2bdd3be5.js';
...
const Modal = class {
  ...
  render() {
    ...
    return (h("div", { class: "modal-container" }, h("div", { class: "modal-body" }, h("div", { class: "modal-header" }, h("div", { class: "header-left" }, h("img", { src: hiroWalletLogoSvg })), h("img", { class: "header-right", src: closeIconSvg, onClick: () => this.handleCloseModal() })), browser ? (h("div", { class: "modal-content" }, h("div", { class: "modal-illustration" }, h("img", { src: getAssetPath(downloadHiroWalletAssetPath), width: 310 })), h("span", { class: "modal-title supported" }, "Add Hiro Wallet to ", browser), h("div", { class: "modal-subtitle" }, "Hiro Wallet is your gateway to Stacks apps like ", this.authOptions.appDetails.name, ". Add it to ", browser, " to continue."))) : (h("div", { class: "modal-content" }, h("div", { class: "modal-illustration" }, h("img", { src: getAssetPath(browserNotSupportedAssetPath), width: 239 })), h("span", { class: "modal-title unsupported" }, "Your browser isn't supported"), h("div", { class: "modal-subtitle" }, "To sign in to ", this.authOptions.appDetails.name, " using the Hiro Wallet browser extension, try", ` `, h("a", { href: CHROME_BROWSER_URL, target: "_blank" }, "Chrome"), `, `, h("a", { href: BRAVE_BROWSER_URL, target: "_blank" }, "Brave"), `, or `, h("a", { href: FIREFOX_BROWSER_URL, target: "_blank" }, "Firefox"), ` on desktop.`))), this.hasOpenedInstall ? (h("div", { class: "modal-subtitle" }, "After installing Hiro Wallet, reload this page and sign in.")) : browser ? (h("div", { class: "button-container" }, h("button", { class: "button", onClick: () => {
