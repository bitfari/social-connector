...
class TransactionSigner {
    constructor(transaction) {
        ...
        if (spendingCondition && !authorization_1.isSingleSig(spendingCondition)) {
            ...
            spendingCondition.fields.forEach(field => {
                if (field.contents.type === constants_1.StacksMessageType.MessageSignature) {
                    ...
                    const nextVerify = authorization_1.nextVerification(this.sigHash, transaction.auth.authType, spendingCondition.fee, spendingCondition.nonce, constants_1.PubKeyEncoding.Compressed, signature);
