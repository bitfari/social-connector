...
function createTokenTransferPayload(recipient, amount, memo) {
    ...
    return {
        ...
        recipient,
        amount: common_1.intToBigInt(amount, false),
...
function createContractCallPayload(contractAddress, contractName, functionName, functionArgs) {
    if (typeof contractAddress === 'string') {
        contractAddress = postcondition_types_1.createAddress(contractAddress);
    }
    if (typeof contractName === 'string') {
        contractName = postcondition_types_1.createLPString(contractName);
    }
    if (typeof functionName === 'string') {
        functionName = postcondition_types_1.createLPString(functionName);
    }
    return {
        type: constants_1.StacksMessageType.Payload,
...
function serializePayload(payload) {
    ...
    switch (payload.payloadType) {
        case constants_1.PayloadType.TokenTransfer:
            ...
            bufferArray.push(common_1.intToBytes(payload.amount, false, 8));
...
function deserializePayload(bufferReader) {
    ...
    switch (payloadType) {
        case constants_1.PayloadType.TokenTransfer:
            ...
            const amount = common_1.intToBigInt(bufferReader.readBuffer(8), false);
