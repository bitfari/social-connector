...
export declare function estimateTransaction(transactionPayload: Payload, estimatedLen?: number, network?: StacksNetwork): Promise<[FeeEstimation, FeeEstimation, FeeEstimation]>;
