...
class StacksTransaction {
    ...
    appendPubkey(publicKey) {
        ...
        if (cond && !(0, authorization_1.isSingleSig)(cond)) {
            ...
            cond.fields.push((0, authorization_1.createTransactionAuthField)(compressed ? constants_1.PubKeyEncoding.Compressed : constants_1.PubKeyEncoding.Uncompressed, publicKey));
        }
        else {
    ...
    signAndAppend(condition, curSigHash, authType, privateKey) {
        ...
        if ((0, authorization_1.isSingleSig)(condition)) {
            ...
            condition.fields.push((0, authorization_1.createTransactionAuthField)(compressed ? constants_1.PubKeyEncoding.Compressed : constants_1.PubKeyEncoding.Uncompressed, nextSig));
        }
        return nextSigHash;
    }
    txid() {
    ...
    serialize() {
        ...
        bufferArray.push((0, authorization_1.serializeAuthorization)(this.auth));
        bufferArray.appendByte(this.anchorMode);
        bufferArray.appendByte(this.postConditionMode);
        bufferArray.push((0, types_1.serializeLPList)(this.postConditions));
        bufferArray.push((0, payload_1.serializePayload)(this.payload));
...
function deserializeTransaction(data) {
    ...
    const auth = (0, authorization_1.deserializeAuthorization)(bufferReader);
    ...
    const postConditions = (0, types_1.deserializeLPList)(bufferReader, constants_1.StacksMessageType.PostCondition);
    const payload = (0, payload_1.deserializePayload)(bufferReader);
