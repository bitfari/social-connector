...
async function getNonce(address, network) {
    ...
    const response = await (0, common_2.fetchPrivate)(url);
    if (!response.ok) {
        let msg = '';
        try {
...
async function estimateTransfer(transaction, network) {
    ...
    const response = await (0, common_2.fetchPrivate)(url, fetchOptions);
    if (!response.ok) {
        let msg = '';
        try {
            msg = await response.text();
...
async function estimateTransaction(transactionPayload, estimatedLen, network) {
    ...
    const response = await (0, common_2.fetchPrivate)(url, options);
    if (!response.ok) {
        let msg = '';
        try {
            msg = await response.text();
...
function makeStandardSTXPostCondition(address, conditionCode, amount) {
    return (0, postcondition_1.createSTXPostCondition)((0, types_1.createStandardPrincipal)(address), conditionCode, amount);
}
...
function makeContractSTXPostCondition(address, contractName, conditionCode, amount) {
    return (0, postcondition_1.createSTXPostCondition)((0, types_1.createContractPrincipal)(address, contractName), conditionCode, amount);
}
...
function makeStandardFungiblePostCondition(address, conditionCode, amount, assetInfo) {
    return (0, postcondition_1.createFungiblePostCondition)((0, types_1.createStandardPrincipal)(address), conditionCode, amount, assetInfo);
}
...
function makeContractFungiblePostCondition(address, contractName, conditionCode, amount, assetInfo) {
    return (0, postcondition_1.createFungiblePostCondition)((0, types_1.createContractPrincipal)(address, contractName), conditionCode, amount, assetInfo);
}
...
function makeStandardNonFungiblePostCondition(address, conditionCode, assetInfo, assetName) {
    return (0, postcondition_1.createNonFungiblePostCondition)((0, types_1.createStandardPrincipal)(address), conditionCode, assetInfo, assetName);
}
...
function makeContractNonFungiblePostCondition(address, contractName, conditionCode, assetInfo, assetName) {
    return (0, postcondition_1.createNonFungiblePostCondition)((0, types_1.createContractPrincipal)(address, contractName), conditionCode, assetInfo, assetName);
}
