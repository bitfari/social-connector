...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fetchPrivate": () => (/* binding */ fetchPrivate)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Buffer": () => (/* binding */ AvailableBufferModule),
...
/* harmony export */   "intToBN": () => (/* binding */ intToBN),
...
const AvailableBufferModule = typeof Buffer !== "undefined" ? Buffer : buffer___WEBPACK_IMPORTED_MODULE_0__.Buffer;
...
function getGlobalObject(name, { throwIfUnavailable, usageDesc, returnEmptyObject } = {}) {
  ...
  try {
    ...
    _logger__WEBPACK_IMPORTED_MODULE_2__.Logger.error(`Error getting object '${name}' from global scope '${globalScope}': ${error}`);
  }
  if (throwIfUnavailable) {
    const errMsg = getAPIUsageErrorMessage(globalScope, name.toString(), usageDesc);
    _logger__WEBPACK_IMPORTED_MODULE_2__.Logger.error(errMsg);
...
function getGlobalObjects(names, { throwIfUnavailable, usageDesc, returnEmptyObject } = {}) {
  ...
  try {
    ...
    _logger__WEBPACK_IMPORTED_MODULE_2__.Logger.error(`Error getting global scope: ${error}`);
    if (throwIfUnavailable) {
...
function intToBN(value, signed) {
  ...
  return new (bn_js__WEBPACK_IMPORTED_MODULE_1___default())(bigInt.toString());
}
function intToBigInt(value, signed) {
  ...
  if (parsedValue instanceof Uint8Array || AvailableBufferModule.isBuffer(parsedValue)) {
    if (signed) {
      const bn = new (bn_js__WEBPACK_IMPORTED_MODULE_1___default())(parsedValue, "be").fromTwos(parsedValue.byteLength * 8);
      return BigInt(bn.toString());
    } else {
      return BigInt(new (bn_js__WEBPACK_IMPORTED_MODULE_1___default())(parsedValue, "be").toString());
    }
  }
  if (parsedValue instanceof (bn_js__WEBPACK_IMPORTED_MODULE_1___default()) || bn_js__WEBPACK_IMPORTED_MODULE_1___default().isBN(parsedValue)) {
...
/* harmony export */   "fetchPrivate": () => (/* reexport safe */ _fetchUtil__WEBPACK_IMPORTED_MODULE_2__.fetchPrivate),
/* harmony export */   "Logger": () => (/* reexport safe */ _logger__WEBPACK_IMPORTED_MODULE_3__.Logger),
/* harmony export */   "BLOCKSTACK_HANDLER": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.BLOCKSTACK_HANDLER),
/* harmony export */   "Buffer": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.Buffer),
/* harmony export */   "getAesCbcOutputLength": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.getAesCbcOutputLength),
/* harmony export */   "getBase64OutputLength": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.getBase64OutputLength),
/* harmony export */   "getGlobalObject": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.getGlobalObject),
/* harmony export */   "getGlobalObjects": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.getGlobalObjects),
/* harmony export */   "getGlobalScope": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.getGlobalScope),
/* harmony export */   "hexToBigInt": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.hexToBigInt),
/* harmony export */   "intToBN": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.intToBN),
/* harmony export */   "intToBigInt": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.intToBigInt),
/* harmony export */   "intToBytes": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.intToBytes),
/* harmony export */   "isLaterVersion": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.isLaterVersion),
/* harmony export */   "isSameOriginAbsoluteUrl": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.isSameOriginAbsoluteUrl),
/* harmony export */   "makeUUID4": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.makeUUID4),
/* harmony export */   "megabytesToBytes": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.megabytesToBytes),
/* harmony export */   "nextHour": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.nextHour),
/* harmony export */   "nextMonth": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.nextMonth),
/* harmony export */   "nextYear": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.nextYear),
/* harmony export */   "updateQueryStringParameter": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.updateQueryStringParameter),
/* harmony export */   "utf8ToBytes": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.utf8ToBytes),
/* harmony export */   "with0x": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.with0x),
/* harmony export */   "BLOCKSTACK_DEFAULT_GAIA_HUB_URL": () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_5__.BLOCKSTACK_DEFAULT_GAIA_HUB_URL),
/* harmony export */   "ChainID": () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_5__.ChainID),
/* harmony export */   "TransactionVersion": () => (/* reexport safe */ _constants__WEBPACK_IMPORTED_MODULE_5__.TransactionVersion)
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config */ "./src/config.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors */ "./src/errors.ts");
/* harmony import */ var _fetchUtil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fetchUtil */ "./src/fetchUtil.ts");
