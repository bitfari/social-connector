 ...
 */
export declare type HandlerParamsEvent = MouseEvent & TouchEvent & KeyboardEvent;
/**
 * Pass the event handler. It's used to determine the position of the cursor
 */
export declare type TriggerEvent = MouseEvent | TouchEvent | KeyboardEvent | React.MouseEvent | React.TouchEvent | React.KeyboardEvent;
export interface ContextMenuParams extends Omit<ShowContextMenuParams, 'id'> {
    id?: MenuId;
}
export declare type BooleanPredicate = boolean | ((args: HandlerParams) => boolean);
/**
 ...
 * ```
 */
export declare type PredicateParams<Props = any, Data = any> = HandlerParams<Props, Data>;
/**
 ...
 * ```
 */
export interface ItemParams<Props = any, Data = any> extends HandlerParams<Props, Data> {
    event: React.MouseEvent<HTMLElement> | React.TouchEvent<HTMLElement> | React.KeyboardEvent<HTMLElement>;
}
 ...
 * animation.fade
 */
export declare type MenuAnimation = string | false | {
    enter: string | false;
    exit: string | false;
};
export {};
