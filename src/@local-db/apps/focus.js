...
const data = {
  tasks: [
    {
      id: 1,
      title: 'Type your goals here as if they were keyword you are searching for...',
      dueDate: '2022-08-20',
      description:
        'Type your goals here as if they were keyword you are searching for...',
      assignee: {
        fullName: '',
        avatar: ''
      },
...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/focus/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/focus/add-tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost('/apps/focus/update-task').reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete('/apps/focus/delete-task').reply(config => {
