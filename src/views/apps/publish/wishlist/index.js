...
// ** Styles
import '@styles/base/pages/app-network.scss'
...
const Wishlist = () => {
  ...
  return (
    <Fragment>
      <BreadCrumbs breadCrumbTitle='Wishlist' breadCrumbParent='Network' breadCrumbActive='Wishlist' />
